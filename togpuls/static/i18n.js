...
const I18N_STRINGS = {
  no: {
    ...
    "install_brew_b": "Tre kommandoer i Terminal. Homebrew håndterer signering-omgåelse og oppdateringer for deg — kjør de to første for å installere, og den siste senere for å oppdatere.",
  ...
  en: {
    ...
    "install_brew_b": "Three commands in Terminal. Homebrew handles the signing workaround and updates for you — run the first two to install, and the last one later to update.",
