...
const I18N_STRINGS = {
  no: {
    ...
    "time_in": "om {n} min",
    "bar_future_tooltip": "{realised} planlagt, {cancelled} kansellert, {scheduled} totalt",
    "bar_past_tooltip": "{realised} gått, {cancelled} kansellert, {scheduled} totalt",
  ...
  en: {
    ...
    "time_ago": "{n} min ago",
    "time_in": "in {n} min",
    "bar_future_tooltip": "{realised} scheduled, {cancelled} cancelled, {scheduled} total",
    "bar_past_tooltip": "{realised} run, {cancelled} cancelled, {scheduled} total",
