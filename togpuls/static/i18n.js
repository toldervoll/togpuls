...
const I18N_STRINGS = {
  no: {
    ...
    "sit_delay": "+{dur}",
    "sit_cancel_risk": "Innstilt-risiko {pct}",
    ...
    "rate_cancel": "Innstilt-risiko: {pct}",
    "rate_delay": "Forsinkelse: typisk +{dur}",
    "dur_min": "{n} min",
    "dur_h": "{h} t",
    "dur_hm": "{h} t {m} min",
    "sev_label.hoy": "HØY",
  ...
  en: {
    ...
    "sit_delay": "+{dur}",
    "sit_cancel_risk": "Cancel risk {pct}",
    ...
    "rate_cancel": "Cancel risk: {pct}",
    "rate_delay": "Delay: typically +{dur}",
    "dur_min": "{n} min",
    "dur_h": "{h}h",
    "dur_hm": "{h}h {m}m",
    "sev_label.hoy": "HIGH",
